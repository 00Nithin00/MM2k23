...
import pic22 from '../Images/Spo22.jpeg';
function Sponsors() {
  return (
    <>
    <div className="main-spon">
    <div>
      <h1 className="About">SPONSORS</h1>
    </div>
    <div className='sponsor-marquee'>
      {/* <h1 className='sponsorHead'>Our Sponsors</h1> */}
